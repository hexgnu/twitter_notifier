...
module Bundler
  ENV_LOADED   = true
  LOCKED_BY    = '0.9.26'
  FINGERPRINT  = "d876899c4749674e097d519806edec77874dc4fc"
  HOME         = '/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/bundler'
  AUTOREQUIRES = {:default=>[["delayed_job", false], ["httparty", false]]}
  SPECS        = [
        {:load_paths=>["/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/gems/crack-0.1.6/lib"], :loaded_from=>"/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/specifications/crack-0.1.6.gemspec", :name=>"crack"},
        {:load_paths=>["/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/gems/daemons-1.0.10/lib"], :loaded_from=>"/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/specifications/daemons-1.0.10.gemspec", :name=>"daemons"},
        {:load_paths=>["/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/gems/delayed_job-2.0.3/lib"], :loaded_from=>"/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/specifications/delayed_job-2.0.3.gemspec", :name=>"delayed_job"},
        {:load_paths=>["/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/gems/httparty-0.5.2/lib"], :loaded_from=>"/Users/matthewkirk/.rvm/gems/ruby-1.8.7-p174/specifications/httparty-0.5.2.gemspec", :name=>"httparty"},
      ].map do |hash|
